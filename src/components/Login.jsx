      ...
      >
        ...
        >
          <div class="my-3 text-4xl font-bold tracking-wider text-center">
            <a href="#">WEOLCOME Menarini Indria Laboratories</a>
          </div>
        ...
        <div class="p-5 bg-white md:flex-1">
          ...
          <form action="#" class="flex flex-col space-y-5">
            ...
            <NavLink to={"/dashboard"}>
              <button
                type="submit"
                class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-red-400 rounded-md shadow hover:bg-red-600 focus:outline-none focus:ring-red-200 focus:ring-4"
              >
                Log in
              </button>
            </NavLink>
            ...
            <div class="flex flex-col space-y-5">
              ...
              <div class="flex flex-col space-y-4">
                ...
                >
                  ...
                  <span class="text-sm font-medium text-gray-800 group-hover:text-white">Gmail</span>
                </a>
                {/* <a
                  href="#"
